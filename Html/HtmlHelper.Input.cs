...
namespace System.Web.WebPages.Html {
    public partial class HtmlHelper {
        ...
        public IHtmlString TextBox(string name, object value, object htmlAttributes) {
            return TextBox(name, value, ObjectToDictionary(htmlAttributes));
        }
        ...
        public IHtmlString Hidden(string name, object value, object htmlAttributes) {
            return Hidden(name, value, ObjectToDictionary(htmlAttributes));
        }
        ...
        public IHtmlString Password(string name, object value, object htmlAttributes) {
            return Password(name, value, ObjectToDictionary(htmlAttributes));
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1308:NormalizeStringsToUppercase", Justification="Input types are specified in lower case")]
